...
namespace V
{
    ...
    public class GameCentalPr : Singleton<GameCentalPr>
    {
        ...
        EntityCore leUnitProcessor;
        AnimationSys leUnitAnimationManager;
        RotationSys leUnitBasicMovementManager;
 

        public EntityCore PlayerProcessor { get { if (leUnitProcessor == null) { InitalTarget(); } return leUnitProcessor; } }
        public AnimationSys PlayerAnimationManager { get { if (leUnitAnimationManager == null) { InitalTarget(); } return leUnitAnimationManager; } }
        public RotationSys PlayerBasicMovementManager { get { if (leUnitBasicMovementManager == null) { InitalTarget(); } return leUnitBasicMovementManager; } }
